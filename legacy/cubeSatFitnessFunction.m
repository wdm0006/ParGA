...
for j=0:ts:tf
    ...
    w1(end+1) = w1(end)+ts*omegadot(1); 
    w2(end+1) = w2(end)+ts*omegadot(2); 
    w3(end+1) = w3(end)+ts*omegadot(3); 
    q1(end+1) = q1(end)+ts*qdots(1);                                                    
    q2(end+1) = q2(end)+ts*qdots(2);                                                    
    q3(end+1) = q3(end)+ts*qdots(3);                                                         
    q4(end+1) = q4(end)+ts*q4dot;                                                          
    rs1(end+1) = rs1(end)+ts*alphax;
    rs2(end+1) = rs2(end)+ts*alphay;
    rs3(end+1) = rs3(end)+ts*alphaz;
    t(end+1)=t(end)+ts;
end
